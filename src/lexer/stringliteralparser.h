#ifndef HYDROGEN_SRC_LEXER_STRINGLITERALPARSER
#define HYDROGEN_SRC_LEXER_STRINGLITERALPARSER
...
public:
    StringLiteralParser(llvm::ArrayRef<Token> string_tokens, const Preprocessor &preprocessor)
    {
...
#endif /* HYDROGEN_SRC_LEXER_STRINGLITERALPARSER */
